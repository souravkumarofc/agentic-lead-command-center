...
export const Navigation: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-50 h-16 border-b border-ops-border bg-ops-bg/90 backdrop-blur-md px-4 lg:px-6 flex items-center justify-between gap-4">
      {/* Brand & System Status */}
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2.5">
          <div className="relative flex items-center justify-center w-9 h-9 rounded-lg bg-ops-surface border border-cyan-500/40 shadow-inner">
            <Cpu className="w-5 h-5 text-ops-cyan animate-pulse" />
            <div className="absolute -top-1 -right-1 w-2.5 h-2.5 rounded-full bg-emerald-500 ring-2 ring-ops-bg" />
          </div>
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] px-1.5 py-0.5 rounded bg-cyan-950/80 text-ops-cyan border border-cyan-800/60 font-mono">
                v2.4-PROD
              </span>
            </div>
            <div className="flex items-center gap-1.5 text-[11px] text-slate-400 font-mono">
              <span className="inline-block w-1.5 h-1.5 rounded-full bg-emerald-400 animate-ping" />
              <span>PIPELINE_ENGINE: ONLINE</span>
      ...
      <nav className="flex items-center p-1 rounded-lg bg-ops-surface border border-ops-border">
        <button
        ...
        <button
          ...
          className={`relative flex items-center gap-2 px-3.5 py-1.5 rounded-md text-xs font-medium transition-all ${
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="hidden sm:flex items-center gap-1 px-2 py-1 rounded-lg bg-ops-surface border border-ops-border">
          <button
            id="sim-toggle-btn"
          ...
          {!isSimulationRunning && (
            <button
              ...
              className="px-2 py-0.5 rounded text-[11px] font-mono text-slate-300 hover:bg-slate-800 border border-slate-700"
            >
              Step
            </button>
          )}
        ...
        <button
          ...
          onClick={() => injectLead()}
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-ops-cyan/10 text-ops-cyan border border-ops-cyan/40 hover:bg-ops-cyan/20 transition-all text-xs font-mono font-medium shadow-sm hover:border-ops-cyan"
        >
          <PlusCircle className="w-3.5 h-3.5" />
          <span className="hidden md:inline">Inject Lead</span>
        </button>
      </div>
    </header>
  );
